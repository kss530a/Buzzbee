...
class MyWindow(QMainWindow, ui):
    ...
    def addInterestCompany(self):
        ...
        self.kiwoom.insert_interest_company_table(pcode1)
        self.kiwoom.update_interest_company(pcode1)
        print(pcode1 + " addInterestCompany Complete")
        self.putInterestCompany()
        self.setRealTime()
